 ...
 * @author egarces
 */
public class ListaBodega extends New_Connection {
    //private final String bdp      = "autenticar";
    
    public ListaBodega() throws Exception {
    ...
    public String[][] getData()
    {
       ...
       // filas = new String[20][20];
        ...
        try
        {
            String consulta = "SELECT ID_Bodega FROM Bodega";
    ...
    public static void main(String[] args)
    {
        ...
        try {
           ...
           /*ArrayList niv = co.columnasGrafico("panel_ordenado", "pp", "agenda");
            ...
            Logger.getLogger(ListaBodega.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
