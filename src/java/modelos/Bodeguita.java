 ...
 * @author egarces
 */
public class Bodeguita extends New_Connection {
    //private final String bdp      = "autenticar";
    
    public Bodeguita() throws Exception {
    ...
    public String[][] getData()
    {
       ...
       // filas = new String[20][20];
        ...
        try
        {
            String consulta = "SELECT B.DescripcionBodega,B.DireccionBodega,COUNT(MP.ID_Lote_MP)\n" +
                                "FROM Bodega B INNER JOIN Lote_Materia_Prima MP\n" +
          ...
          filas = new String[fil][col];
            ...
            while (rs.next()) 
            {
                ...
                filas[i][2] = Integer.toString(rs.getInt(3));
                i++;
            }
        }
    ...
    public static void main(String[] args)
    {
        ...
        try {
           ...
           /*ArrayList niv = co.columnasGrafico("panel_ordenado", "pp", "agenda");
            ...
            Logger.getLogger(Bodeguita.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
}
